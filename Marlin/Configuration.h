...
#define STRING_CONFIG_H_AUTHOR "(@bschwand, default config)" // Original author or contributor.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 244.08             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 135.55 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 6000, 6000, 3000, 20000 } // ...or, set your own edit limits
#endif
...
#define Z_PROBE_FEEDRATE_FAST  (24*60) // (mm/min)
...
#define PROBE_ENABLE_DISABLE
  ...
  #define PROBE_ENABLE_PIN 43   // Override the default pin here
#endif
